...
class AppStrings {
  ...
  String get navHeatmap => _zh ? '热力图' : 'Sport Heatmap';
  ...
  String get paywallTitle => _zh ? '解锁热力图' : 'Unlock Sport Heatmap';
  String get paywallDesc => _zh ? '热力图绘制为付费功能，购买后可终生使用。' : 'Sport Heatmap rendering is a paid feature. One-time purchase, lifetime access.';
  ...
  String get heatmapTitle => _zh ? '热力图' : 'Sport Heatmap';
  String get heatmapSettingsTitle => _zh ? '热力图设置' : 'Sport Heatmap Settings';
  ...
  String get tooltipHeatmapSettings => _zh ? '热力图设置' : 'Sport Heatmap settings';
  String get heatmapNeedAccountHint =>
      _zh ? '请先在设置里绑定/配置账号，然后再加载热力图。' : 'Configure an account in Settings, then load the Sport Heatmap.';
